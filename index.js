...
//
const BotName = 'LnkyNET BOT⚡'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/pin.nation_'; // Nama Instagramlu cok
...
const grupch2 = 'soon'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
